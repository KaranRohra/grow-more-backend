...
def price_prediction_helper(symbol, forecast_days=30):
    global dic, forecast_date, is_predicting
    while is_predicting:
        ...
    is_predicting = True
...
class PricePredictionAPI(views.APIView):
    def get(self, request, *args, **kwargs):
        ...
        price_prediction_helper(symbol, forecast_days)
        return Response(dic[(symbol, forecast_days)])
